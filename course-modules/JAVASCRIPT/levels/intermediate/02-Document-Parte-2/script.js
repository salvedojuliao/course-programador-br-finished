...
Cada tag html pode ser transformada num objeto do javascript, e uma vez que isso acomteça, eu posso fazer bastante
coisa com isso.
Ele cita que com o document eu consigo acessar o body (que é uma propriedade do document), depois disso, eu consigo
acessar o innerHTML e o innerText (Que são propriedades do body), ficaria assim:
...
charset	Deprecated. 
Use characterSet instead. Returns the character encoding for the document
