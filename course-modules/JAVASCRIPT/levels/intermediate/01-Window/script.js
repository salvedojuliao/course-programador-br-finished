/* Window é um objeto padrão que existe em toda página da internet e poussui vários métodos e propriedades importantes
- O Console é uma propriedade do Window por exemplo;
- Eu posso utilizar/chamar propriedades e métodos do Window sem chamar o window.
- Tem o Alert(), atob() etc... (Na página do curso tem vários)
- Console também é um objeto (com métodos e propriedades)
